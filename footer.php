                    ...
                    <div class="col-lg footer-cols col-footerlogo" id="fth-col-img">
                        <div class="row align-items-center">
                            <div class="col-6 col-md-4 col-lg-6 text-start">
                                <img src="./assets/svg/stqc.svg" class="footer-logo img-fluid">
                            </div>
                            <div class="col-6 col-md-4 col-lg-6 text-start">
                                <img src="./assets/svg/gigw.svg" class="footer-logo img-fluid">
                            </div>
                            <div class="w-100"></div>
                            <div class="col-6 col-md-4 col-lg-6 text-start">
                                <img src="./assets/svg/CSM_logo-250.svg" class="footer-logo img-fluid">
                            </div>
                            <div class="col-6 col-md-4 col-lg-6 text-start">
                                <img src="./assets/svg/wcag.svg" class="footer-logo img-fluid">
                            </div>
                        </div>
                    </div>
                    <!--Grid column-->
