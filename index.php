    ...
    <div class="container kg-services">
        <div class="row justify-content-center">
            <div class="col-6 col-lg-2">
                <div class="img-outer">
                    <div style="background-image: url(./assets/svg/multiple-users-silhouette.svg);" class="img-border rounded-circle cs-img">
                    </div>
            ...
            <div class="col-6 col-lg-2">
                <div class="img-outer">
                    <div style="background-image: url(./assets/svg/poster.svg);" class="img-border rounded-circle nt-img">
                    </div>
                    <div class="img-content text-center mt-3">
            ...
            <div class="col-6 col-lg-2">
                <div class="img-outer">
                    <div style="background-image: url(./assets/svg/file.svg);" class="img-border rounded-circle dr-img">
                    </div>
                    <div class="img-content text-center mt-3">
            ...
            <div class="col-6 col-lg-2">
                <div class="img-outer">
                    <div style="background-image: url(./assets/svg/market-fluctuation.svg);" class="img-border rounded-circle dash-img">
                    </div>
                    <div class="img-content text-center mt-3">
            ...
            <div class="col-6 col-lg-2">
                <div class="img-outer">
                    <div style="background-image: url(./assets/svg/image-gallery.svg);" class="img-border rounded-circle med-img">
                    </div>
                    <div class="img-content text-center mt-3">
            ...
            <div class="col-6 col-lg-4">
                <div class="img-outer">
                    <div style="background-image: url(./assets/svg/open-computer-folder.svg);" class="img-border rounded-circle od-img">
                    </div>
                    <div class="img-content text-center mt-3">
            ...
            <div class="col-6 col-lg-4">
                <div class="img-outer">
                    <div style="background-image: url(./assets/svg/chat.svg);" class="img-border rounded-circle gr-img">
                    </div>
                    <div class="img-content text-center mt-3">
            ...
            <div class="col-6 col-lg-4">
                <div class="img-outer">
                    <div style="background-image: url(./assets/svg/headphones-with-microphone.svg);" class="img-border rounded-circle help-img">
                    </div>
                    <div class="img-content text-center mt-3">
        ...
        <div class="kg-alert alert text-lg-start py-lg-5 px-0 px-lg-5" role="alert">
            <div class="row">
                <div class="col-12 col-lg-5 mb-3 mb-lg-0 p-0 pe-lg-4">
                    <img class="img-fluid w-100 h-100" src="./assets/img/3rd-alert-img.jpg" alt="">
                </div>
                    ...
                    <div class="container-fluid px-2">
                        <div class="row align-items-center justify-content-center" id="gov-details">
                            <div class="col-3 col-lg-4 image-gov-cm">
                                <img class="img-fluid" src="./assets/img/governor.png">
                            </div>
                    ...
                    <div id="col-new-updates">
                        ...
                        <div id="news-update-feed" class="justify-content-center d-grid">
                            <a class="" href="#">
                                <div class="rowGroup">
                                    <div class="table-row">
                                        <div class="table-cell news-title ps-md-3">
                                            ...
                                            <br>
                                            <span class="news-date kg-i-font text-white">01/01/2021</span></div>
                                        <div class="table-cell pe-md-3"><span class="red-arrow text-white"><i class="fa fa-chevron-right"></i></span></div>
                                    </div>
                                </div>
                            </a>
                            <a class="" href="#">
                            ...
                            <center class="mt-4"><a href="#" class="text-center justify-content-center kg-iii-font font-poppins-normal text-blue kg-bg-yellow" id="show-all-updates">Show More</a></center>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-lg">
            <div class="row row-no-gutters justify-content-center pt-5">
                <div class="col-12 col-lg-3 text-center pe-lg-4">
                    <img class="img-fluid w-100 h-100 article-current-img" src="./assets/img/img-article.jpg" />
                </div>
                <div class="col-12 col-lg-6 text-center mt-4 text-lg-start kg-iv-font p-0">
                    <div id="article-current">
                        ...
                        <p class="mt-1"><a href="./article.php" class="article-readmore font-mulish-normal fw-bold kg-bg-red text-white">Read More</a></p>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row justify-content-md-center my-5">
                    <div class="col col-lg-2">
                        <img class="img-fluid" src="./assets/svg/PRD.svg">
                    </div>
                    <div class="col col-lg-2 offset-lg-1">
                        <img class="img-fluid" src="./assets/svg/liveprd.svg">
                    </div>
                    <div class="col col-lg-2 offset-lg-1">
                        <img class="img-fluid" src="./assets/svg/newskerala.svg">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="text-center">
            <div class="container">
                ...
                <div class="row justify-content-md-center mt-2">
                    <div class="col col-lg-2">
                        <img class="img-fluid" src="./assets/svg/india-gov.svg">
                    </div>
                    <div class="col col-lg-2">
                        <img class="img-fluid" src="./assets/svg/mygov-logo.svg">
                    </div>
                    <div class="col col-lg-2">
                        <img class="img-fluid" src="./assets/svg/Digital_India_logo.svg">
                    </div>
                    <div class="col col-lg-2">
                        <img class="img-fluid" src="./assets/svg/data-gov_0.svg">
                    </div>
                </div>
            </div>
        </div>
