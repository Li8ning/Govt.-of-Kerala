                ...
                <div class="col-12 col-lg-6 right-sec-news font-roboto-normal">
                    <div id="col-new-updates">
                        ...
                        <a class="" href="#">
                            ...
                            <center class="mt-2"><a href="#" class="text-center justify-content-center kg-iii-font font-poppins-normal text-blue kg-bg-yellow mt-3" id="show-all-updates">Show More</a></center>
                        </div>
                    </div>
                </div>
            </div>
